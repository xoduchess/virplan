//*Add canvas
  // var stage = document.getElementById("thestage");
  // var stageText = stage.getContext("2d"); 
  // stageText.font = "30px Arial";
  // stageText.fillText("Text Sizing", 0, 40);

//*create stage width 
//stage.width = stageText.measureText("Text Sizing").width;
